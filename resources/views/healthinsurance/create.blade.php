...
<div class="flex vh-100">
    <div class="justify-center items-center mx-auto block w-1/2 rounded-lg bg-white p-6 shadow-4 dark:bg-surface-dark">
        <form action="{{ route('insurances.store')}}" method="POST">
            ...
            <h1 class="text-2xl font-bold mt-2 ml-2 mb-2">Nueva Obra Social</h1>
            <!--E-mail input-->
            <div class="relative mb-12">
                <input type="text"
                    ...
                    id="cinsurance_name" name="cinsurance_name" placeholder="Nombre de la Obra Social"
                    value="{{ old('cinsurance_name') }}" required autofocus/>
