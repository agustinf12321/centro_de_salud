...
<div class="flex vh-100">
    <div class="justify-center items-center mx-auto block w-1/2 rounded-lg bg-white p-6 shadow-4 dark:bg-surface-dark">
        <form action="{{ route('specialities.store')}}" method="POST">
            ...
            <h1 class="text-2xl font-bold mt-2 ml-2 mb-2">Nueva Especialidad</h1>
            <!--E-mail input-->
            <div class="relative mb-12">
                <input type="text"
                    ...
                    id="cspeciality_name" name="cspeciality_name" placeholder="Nombre de la Especialidad"
                    value="{{ old('cspeciality_name') }}" required autofocus/>

                <label for="cspeciality_name"
                    class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-valid:-translate-y-[0.95rem] peer-valid:scale-[0.8] peer-focus:-translate-y-[0.95rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-300 dark:peer-focus:text-primary">Nombre
                    de la Especialidad
                </label>
