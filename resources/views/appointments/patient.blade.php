                    ...
                    <table class="min-w-full text-left text-sm font-light text-surface dark:text-black">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-neutral-200 bg-black/[0.02] dark:border-white/10">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">{{$appointment->Patient->cpatient_name}}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{$appointment->Doctor->cdoctor_name}}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{$appointment->Office->coffice_name}}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{$appointment->HealthInsurance->cinsurance_name}}</td>
